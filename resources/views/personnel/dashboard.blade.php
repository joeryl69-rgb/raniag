<x-app-layout>
    <x-slot name="header">
        {{ __('Personnel Response Center') }}
    </x-slot>

    @push('styles')
        <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" integrity="sha256-p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin="">
        <style>
            #personnel-dashboard-map {
                height: 320px;
        ...
        <div class="col-lg-7">
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body p-2">
                    <div id="personnel-dashboard-map"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-5">
            <div class="card h-100 shadow-sm border-0">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush" id="personnel-status-feed" style="max-height: 320px; overflow-y: auto;">
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('personnel.incidents.index') }}" class="btn btn-sm btn-link p-0 text-decoration-none">Open Full List</a>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody id="personnel-dispatches-table-body">
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3" style="z-index: 1080;">
        <div id="personnel-new-toast" class="toast align-items-center text-white bg-danger border-0" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex text-white p-2 align-items-center">
                <div class="toast-body flex-grow-1">
                    ...
                    <span id="personnel-toast-message">You have been assigned a new incident. Check dispatches immediately.</span>
                </div>
        ...
        <script>
            (function () {
                ...
                async function fetchMetrics() {
                    try {
                        const res = await fetch('/personnel/dashboard.json', {
                        ...
                        if (lastAssignmentCount !== null && data.total_assigned_incidents > lastAssignmentCount) {
                            playAlertTone();
                            const toastEl = document.getElementById('personnel-new-toast');
                            const toastMsg = document.getElementById('personnel-toast-message');
                        ...
                        console.error('Error loading personnel dashboard analytics', e);
                    }
                }

                function renderDispatchesTable(items) {
                    const tbody = document.getElementById('personnel-dispatches-table-body');
                    if (!tbody) return;
                    tbody.innerHTML = '';
                    ...
                    items.forEach(inc => {
                        ...
                        row.innerHTML = `
                            ...
                            <td class="px-4 py-3 text-end">
                                <a href="/personnel/incidents/${inc.id}" class="btn btn-sm btn-outline-primary py-1">
                ...
                function renderFeed(updates) {
                    const feed = document.getElementById('personnel-status-feed');
                    if (!feed) return;
                    feed.innerHTML = '';
                    ...
                    updates.forEach(up => {
                        ...
                        div.innerHTML = `
                            ...
                            <a href="/personnel/incidents/${up.incident_id}" class="fs-8 text-decoration-none mt-1 d-inline-block">Open Case File</a>
                        `;
                    ...
                    incidents.forEach(inc => {
                        ...
                        if (Number.isFinite(lat) && Number.isFinite(lng)) {
                            ...
                            marker.bindPopup(`
                                ...
                                <a href="/personnel/incidents/${inc.id}" class="btn btn-xs btn-primary text-white py-0 px-2 mt-1 fs-8" style="font-size: 0.75rem;">Process Case</a>
                            `);

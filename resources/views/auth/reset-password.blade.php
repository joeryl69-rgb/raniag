...
<head>
    ...
    <title>Reset Password — RANIAG</title>
    ...
    <style>
        ...
        .form-control:disabled { background-color: #f3f7f4; color: #5a6b75; }
        ...
        .btn-login:disabled { opacity: 0.9; cursor: wait; }
    ...
    <div class="login-shell">
        <div class="login-card">
            ...
            <div class="login-body">
                <div class="mb-4">
                    <h2 class="h4 fw-semibold mb-1">Reset Password</h2>
                    <p class="helper-text mb-0">Choose a strong new password to secure your account.</p>
                </div>
